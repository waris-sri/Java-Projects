...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("+———————————————————————————————————————+");
            System.out.println(
                "|        \033[32;1mWelcome to Shitty Wordle!\033[0m      |"
            );
            System.out.println(
                "| Enter \033[33m<START>\033[0m to play                 |"
            );
            System.out.println(
                "| Enter \033[33m<RULES>\033[0m to view the rules       |"
            );
            System.out.println(
                "| Enter \033[33m<SCORE>\033[0m to view all your scores |"
            );
            System.out.println(
                "| Enter \033[33m<CLOSE>\033[0m to exit                 |"
            );
            System.out.println(
                "| Enter \033[33m<CHEAT>\033[0m to enable/disable cheat |"
            );
            System.out.println("+———————————————————————————————————————+");
            ...
            switch (input) {
                case "start":
                    ...
                    while (true) {
                        if (cheat == true) {
                            System.out.println(
                                "\033[36;3mCHEAT: The answer is " +
                                randNum +
                                ".\033[0m"
                            );
                        }
                        System.out.println(
                            "\033[33m\nEnter your guess (must be a " +
                            digit +
                        ...
                        if (
                            answer.length() == randNum.length() &&
                            answer.equals(randNum)
                        ) {
                            System.out.println(
                                "\033[32;1mThere are " +
                                digit +
                                " correct number(s).\033[0m\n"
                            );
                            guess++;
                            break;
                            ...
                            System.out.println(
                                "\033[31;1mInvalid guess, try again!\033[0m\n"
                            );
                        }
                    }
                    if (answer.equals("G")) {
                        System.out.println(
                            "\033[35;1mYou gave up. The answer was " +
                            randNum +
                            ".\033[0m"
                        );
                        System.out.println();
                        ...
                        System.out.println(
                            "\033[35;1mCongratulations! It took you " +
                            guess +
                            " guesses to win.\033[0m"
                        );
                        score.add(guess);
                ...
                case "score":
                    if (list.isEmpty()) {
                        System.out.println(
                            "\033[96;3mNo score was recorded.\033[0m"
                        );
                        System.out.println();
                    } else {
                ...
                case "close":
                    System.out.println(
                        "\033[35;1mThank you for playing!\033[0m"
                    );
                    break;
                case "cheat":
                    if (cheat == true) {
